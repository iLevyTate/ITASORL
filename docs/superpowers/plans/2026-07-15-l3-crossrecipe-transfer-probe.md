...
- `itasorl/experiment_b2.py:928` `save_agent_bundle(path, agent, norm)` saves `{"state_dict", "ctor": {obs_dim, act_dim, embed, hidden, world_model, sysid_aux}, "norm": {mean, var, count}}`. There is NO loader yet.
